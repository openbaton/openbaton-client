...
public class NetworkServiceRecordRestAgent extends AbstractRestAgent<NetworkServiceRecord> {
     ...
     */
    public NetworkServiceRecordRestAgent(String username, String password, String projectId, String nfvoIp, String nfvoPort, String path, String version) {
        super(username, password, projectId, nfvoIp, nfvoPort, path, version, NetworkServiceRecord.class);
    }
