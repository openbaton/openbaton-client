...
public class RequestFactory {
    ...
    public ImageRestAgent getImageAgent() {
        if (imageRequest == null) {
            imageRequest = new ImageRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getRestImageUrl(), version);
        }
        return imageRequest;
    }
    ...
    public NetworkServiceDescriptorRestAgent getNetworkServiceDescriptorAgent() {
        if (networkServiceDescriptorRequest == null) {
            networkServiceDescriptorRequest = new NetworkServiceDescriptorRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getRestNetworkServiceDescriptorUrl(), version);
        }
    ...
    public NetworkServiceRecordRestAgent getNetworkServiceRecordAgent() {
        if (networkServiceRecordRequest == null) {
            networkServiceRecordRequest = new NetworkServiceRecordRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getRestNetworkServiceRecordUrl(), version);
        }
    ...
    public VimInstanceRestAgent getVimInstanceAgent() {
        if (vimInstanceRequest == null) {
            vimInstanceRequest = new VimInstanceRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getRestVimInstanceUrl(), version);
        }
    ...
    public VirtualLinkRestAgent getVirtualLinkAgent() {
        if (virtualLinkRequest == null) {
            virtualLinkRequest = new VirtualLinkRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getRestVirtualLinkUrl(), version);
        }
    ...
    public VirtualNetworkFunctionDescriptorRestAgent getVirtualNetworkFunctionDescriptorAgent() {
        if (virtualNetworkFunctionDescriptorRequest == null) {
            virtualNetworkFunctionDescriptorRequest = new VirtualNetworkFunctionDescriptorRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getRestVirtualNetworkFunctionDescriptorUrl(), version);
        }
    ...
    public VNFFGRestAgent getVNFForwardingGraphAgent() {
        if (vNFFGRequest == null) {
            vNFFGRequest = new VNFFGRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getRestVNFFGUrl(), version);
        }
        return vNFFGRequest;
    }
    ...
    public EventAgent getEventAgent() {
        if (eventAgent == null) {
            eventAgent = new EventAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getEventUrl(), version);
        }
        return eventAgent;
    }
    ...
    public VNFPackageAgent getVNFPackageAgent() {
        if (vnfPackageAgent == null) {
            vnfPackageAgent = new VNFPackageAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getVNFPackageUrl(), version);
        }
    ...
    public ProjectAgent getProjectAgent() {
        if (projectAgent == null) {
            projectAgent = new ProjectAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getProjectUrl(), version);
        }
        return projectAgent;
    }
    ...
    public UserAgent getUserAgent() {
        if (userAgent == null) {
            userAgent = new UserAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, propertyReader.getUserUrl(), version);
        }
        return userAgent;
    }

    public AbstractRestAgent getAbstractAgent(Class clazz, String path) {
        return new AbstractRestAgent(username, password, projectId, sslEnabled, nfvoIp, nfvoPort, path, version, clazz);
    }
}
